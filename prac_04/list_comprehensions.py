...
full_names = ['John Doe', 'Alice Wonderland', 'Bob Marley', 'Malcolm X', 'Langston Hughes', 'Jimi Hendrix', 'Ada Lovelace', 'Martin Luther King Jr.', 'Billie Holiday', 'Harriet Tubman']
